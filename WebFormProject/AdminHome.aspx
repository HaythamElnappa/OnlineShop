<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="WebFormProject.WebForm1" %>
...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="ShowUserNew.aspx">User</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="ProductView.aspx">Product</a>
      </li>
      <li class="nav-item dropdown">
          <a class="nav-link " href="orderView.aspx">Orders</a>
